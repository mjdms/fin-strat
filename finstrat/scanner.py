...
from finstrat.data_fetcher import fetch_multi_timeframe
from finstrat.technical import calculate_advanced_indicators
from finstrat.scrapers import get_live_news
from finstrat.sentiment import analyze_texts
from finstrat.signal_engine import calculate_technical_score, calculate_volume_score, generate_signal, calculate_price_targets
from finstrat.report import print_report
...
def run_scanner(tickers: list[str], interval_seconds: int = 300):
    ...
    """
    console.print(f"\n[bold blue]=== Starting Fin-Strat Background Scanner ===[/bold blue]")
...
def run_screener(tickers: list[str], use_finbert: bool = False):
    ...
    """
    console.print(f"\n[bold cyan]=== Fin-Strat Autonomous Market Screener ===[/bold cyan]")
