...
from finstrat.scanner import run_analysis, run_scanner
from finstrat.report import print_report

app = typer.Typer(help="Fin-Strat: Local Market Analysis & Technical Intelligence CLI")
console = Console()
...
def screen(
    ...
    from finstrat.scanner import run_screener
...
def interactive():
    ...
    """
    console.print("\n[bold cyan]=== Fin-Strat Interactive Shell ===[/bold cyan]")
    ...
    while True:
        try:
            user_input = console.input("[bold green]Finstrat>[/bold green] ").strip()
